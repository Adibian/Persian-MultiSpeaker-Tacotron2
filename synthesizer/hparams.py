...
hparams = HParams(
        ...
        tts_schedule = [(2,  1e-3,  10_000,  32),   # Progressive training schedule
                        (2,  5e-4,  20_000,  32),   # (r, lr, step, batch_size)
                        (2,  2e-4,  40_000,  32),   #
                        (2,  1e-4,  80_000,  32),   # r = reduction factor (# of mel frames
                        (2,  3e-5, 160_000,  32),   #     synthesized for each decoder iteration)
                        (2,  1e-5, 320_000,  32)],  # lr = learning rate
